...
@Tag(name = "ProdutoGetController", description = "Adaptador para buscar recurso Produto.")
@RestController
...
public final class ProdutoGetController implements IProdutoController.GetController {
  ...
  public ResponseEntity<Page<ProdutoDtoResponse>> pesquisar(
    @Parameter(name = "ProdutoFiltro", description = "Estrutura de dados usada como filtro de pesquisa.", required = false)
