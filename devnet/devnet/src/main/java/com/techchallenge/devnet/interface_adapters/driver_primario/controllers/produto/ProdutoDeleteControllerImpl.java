...
@Tag(name = "ProdutoDeleteControllerImpl", description = "Adaptador para padronizar a requisição às normalizações da API.")
@RestController
@RequestMapping(path = "/api/v1/produtos")
public final class ProdutoDeleteControllerImpl implements ProdutoControllerPort.DeleteController {

  private final ProdutoApagarServicePort service;

  private final DeletePresenter presenter;

  public ProdutoDeleteControllerImpl(ProdutoApagarServicePort service,
