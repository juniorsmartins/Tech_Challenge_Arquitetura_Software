...
import com.techchallenge.devnet.frameworks_and_drivers.web.ProdutoControllerPort;
import com.techchallenge.devnet.interface_adapters.driver_primario.presenters.DeletePresenter;
import com.techchallenge.devnet.application_business_rules.ports.entrada.produto.IProdutoApagarServicePort;
...
public final class ProdutoDeleteControllerImpl implements ProdutoControllerPort.DeleteController {

  private final IProdutoApagarServicePort service;

  private final DeletePresenter presenter;

  public ProdutoDeleteControllerImpl(IProdutoApagarServicePort service,
