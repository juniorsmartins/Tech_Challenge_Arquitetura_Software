...
import com.techchallenge.devnet.core.application.exceptions.http_400.RequisicaoMalFormuladaException;
import com.techchallenge.devnet.core.application.exceptions.http_404.RecursoNaoEncontradoException;
...
public final class TratadorDeExceptions extends ResponseEntityExceptionHandler {
  ...
  public TratadorDeExceptions(MessageSource mensagemInternacionalizada) {
