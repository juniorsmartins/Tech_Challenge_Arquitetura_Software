...
@Slf4j
@Service
public class EmailPostServiceImpl implements EmailEnviarServicePort {
  ...
  private final EmailSalvarRepositoryPort emailSalvarRepository;

  public EmailPostServiceImpl(UtilsCliente utilsCliente,
                              UtilsPedido utilsPedido,
                              JavaMailSender javaMailSender,
                              EmailSalvarRepositoryPort emailSalvarRepository) {
